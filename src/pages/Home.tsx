...
export function Home() {
    ...
    async function handleJoinRoom(event: FormEvent) {
        ...
        if (!roomRef.exists()) {
            alert('A sala que você informou não existe, verifique novamente seu código.');
            return;
        }

        if (roomRef.val().endedAt) {
            alert('Infelizmente essa sala já foi encerrada, peça ao administrador para a recriar.');
            return;
        }
